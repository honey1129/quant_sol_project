...
# 信号平滑参数
SMOOTH_ALPHA=os.getenv("SMOOTH_ALPHA", 0.3)


# 仓位边界
POSITION_MIN = os.getenv("POSITION_MIN", 0.05)
POSITION_MAX = os.getenv("POSITION_MAX", 0.3)
MAX_POSITION_RATIO = os.getenv("MAX_POSITION_RATIO", 0.3)
MIN_ADJUST_AMOUNT = os.getenv("MIN_ADJUST_AMOUNT", 50)
ADJUST_UNIT = os.getenv("ADJUST_UNIT", 50)

# Kelly 盈亏比
KELLY_REWARD_RISK = os.getenv("KELLY_REWARD_RISK", 2.5)

# 动态风险预算
TARGET_VOL = os.getenv("TARGET_VOL", 0.015)

# 回测参数
MAX_POSITION = os.getenv("MAX_POSITION", 0.4)
INITIAL_BALANCE = os.getenv("INITIAL_BALANCE", 1000)

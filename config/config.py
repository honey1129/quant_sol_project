...
MODEL_VALIDATION_LGB_ESTIMATORS = int(os.getenv("MODEL_VALIDATION_LGB_ESTIMATORS", 120))
MODEL_VALIDATION_XGB_ESTIMATORS = int(os.getenv("MODEL_VALIDATION_XGB_ESTIMATORS", 120))
MODEL_VALIDATION_RF_ESTIMATORS = int(os.getenv("MODEL_VALIDATION_RF_ESTIMATORS", 80))
...
MODEL_WALK_FORWARD_LGB_ESTIMATORS = int(os.getenv("MODEL_WALK_FORWARD_LGB_ESTIMATORS", 120))
MODEL_WALK_FORWARD_XGB_ESTIMATORS = int(os.getenv("MODEL_WALK_FORWARD_XGB_ESTIMATORS", 120))
MODEL_WALK_FORWARD_RF_ESTIMATORS = int(os.getenv("MODEL_WALK_FORWARD_RF_ESTIMATORS", 80))

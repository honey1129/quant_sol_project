...
MODEL_LABEL_TIMEOUT_MIN_NET_RETURN = float(os.getenv("MODEL_LABEL_TIMEOUT_MIN_NET_RETURN", 0.0))
MODEL_LABEL_TIMEOUT_MAX_MAE_RATIO = float(os.getenv("MODEL_LABEL_TIMEOUT_MAX_MAE_RATIO", 0.60))

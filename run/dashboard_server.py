        ...
        rows.append(
            {
                ...
                "entry_source": "position_snapshot" if "执行开仓" in message and entry_price is not None else "not_recorded",
                "exit": current_price if "执行平仓" in message else None,
                "exit_source": "market_snapshot" if "执行平仓" in message and current_price is not None else "not_recorded",
                "pnl": None,
                "pnl_source": "not_recorded",
                "fee": None,
                "fee_source": "not_recorded",
                "slippage": None,
                "slippage_source": "not_recorded",
